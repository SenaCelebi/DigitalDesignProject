...
constant val: std_logic_vector (15 downto 0):="0000000000000000";	--load 00 := 0000 0000 
...
--            if temp_count>0 then
                ...
                if temp_count(3 downto 0)=9 then
                    temp_count(3 downto 0)<="0000";
                if temp_count(7 downto 4)=9 then
                    temp_count(7 downto 4)<="0000";
                if temp_count(11 downto 8)=9 then
                    temp_count(11 downto 8)<="0000";
                if temp_count(15 downto 12)=9 then
                    temp_count(15 downto 12)<="0000";
                        else
                ...
                if temp_count>valup-1  then  -- when display equal to 20,  restart with 00!!! 
                    temp_count<=val;
		end if;                                                            
           end if;
   end if;
